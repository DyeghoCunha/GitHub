...
import CalculaFatorR from './CalculaFatorR/CalculaFatorR'

export default function FatorR() {
  return (
    <Center w="100vw" h="100%" bgGradient="linear(130deg, rgba(241,226,194,1) 0%, white 40%, rgba(242,242,243,1) 100%)" my={10} overflow="hidden">
