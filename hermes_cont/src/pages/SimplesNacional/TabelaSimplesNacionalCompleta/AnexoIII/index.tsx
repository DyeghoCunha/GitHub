        ...
        <Box w="100%" h="100%" pb={10}>
          <VStack  >
            <Flex w="100%" justify="center" align="center" direction="column">
                  ...
                  <Table>
                    ...
                    <Tbody backgroundImage={image.src} bgPosition="right" bgSize="contain" bgRepeat="no-repeat">
                      ...
                      <Tr _hover={{ outline: "2px solid black" }} >
                        <Td>5ª Faixa	</Td>
                        <Td>43,40%</Td>
                        <Td>33,50%<GradientText>(*)</GradientText></Td>
                        <Td>3,50%</Td>
                        <Td>4,00%</Td>
                        <Td>12,82%</Td>
                        <Td>2,78%</Td>
              ...
              <Text px={5} my={5} fontSize="23px" lineHeight="35px"><GradientText>(*)</GradientText> O percentual efetivo máximo devido ao ISS será de 5%,
