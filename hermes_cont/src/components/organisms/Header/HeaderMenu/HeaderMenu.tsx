    ...
    <Menu>
      ...
      >
        <MenuGroup fontSize="26px" color="white" fontWeight="400" title="Calculadora">
          <MenuItem as={Link} href="/FatorR" fontSize="20px" color="grey" _hover={{ color: "#F1AC19" }} >Fator R</MenuItem>
        ...
        <MenuGroup fontSize="26px" color="white" fontWeight="400" title="Consultar">
          ...
          <MenuItem as={Link} href="/SimplesNacional/TabelaSimplesNacionalCompleta" fontSize="20px" color="grey" _hover={{ color: "#F1AC19" }} >ANEXO</MenuItem>
        </MenuGroup>
        <MenuGroup fontSize="26px" color="white" fontWeight="400" title="Consultar">
          <MenuItem as={Link} href="/ConsultaCnpj" fontSize="20px" color="grey" _hover={{ color: "#F1AC19" }} >CNPJ</MenuItem>
        </MenuGroup>
