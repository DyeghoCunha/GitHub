...
import '../../widgets/circularProgressIndicatorCustom.dart';
import '../SimplesNacional_page/service/simplesNacionalAnexo.dart';

class DadosEmpresaPorCnpjPage extends StatefulWidget {
  DadosEmpresaPorCnpjPage({super.key, required this.cnpj});

  String cnpj;

  @override
  State<DadosEmpresaPorCnpjPage> createState() => _DadosEmpresaPorCnpjPageState();
}

class _DadosEmpresaPorCnpjPageState extends State<DadosEmpresaPorCnpjPage> {
