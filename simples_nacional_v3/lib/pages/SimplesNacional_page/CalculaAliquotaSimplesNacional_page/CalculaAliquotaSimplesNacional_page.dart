...
import 'package:simples_nacional_v3/pages/SimplesNacional_page/service/aliquotaSimplesNacional.dart';
import '../../../components/box_card.dart';
import '../../../service/utilidades.dart';
import '../../../themes/theme_colors.dart';
import '../CalculaSimplesNacional_page/CalculaSimplesNacional_page.dart';

class CalculaAliquotaSimplesNacionalPage extends StatefulWidget {
  CalculaAliquotaSimplesNacionalPage({super.key, required this.rbt12, required this.faturamento});

  String rbt12;
  String faturamento;

  @override
  State<CalculaAliquotaSimplesNacionalPage> createState() => _CalculaAliquotaSimplesNacionalPageState();
}

class _CalculaAliquotaSimplesNacionalPageState extends State<CalculaAliquotaSimplesNacionalPage> {
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => CalculaSimplesNacionalPage(
