...
class CalculaSimplesNacionalPage extends StatefulWidget {
  CalculaSimplesNacionalPage({super.key, required this.faturamento, required this.aliquota, required this
      .anexo,
  required this.rbt12});
  ...
  @override
  State<CalculaSimplesNacionalPage> createState() => _CalculaSimplesNacionalPageState();
}

class _CalculaSimplesNacionalPageState extends State<CalculaSimplesNacionalPage> {
  @override
