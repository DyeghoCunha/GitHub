          ...
          <VStack>
            ...
            <Card w={{ base: "800px", sm: "300px", md: "800px" }} bg="gray.500">
              <form action={formAction}>
                <CardForm>
                  <FormControl >
                    <FormLabel bgGradient="linear(to-b, #B7F9A8, #32821C)" bgClip="text" >Nome do Projeto</FormLabel>
                ...
                <CardForm>
                  <FormControl>
                    <FormLabel bgGradient="linear(to-b, #B7F9A8, #32821C)" bgClip="text">Nome do Autor</FormLabel>
                ...
                <CardForm>
                  <FormControl>
                    <FormLabel bgGradient="linear(to-b, #B7F9A8, #32821C)" bgClip="text">Resumo do Projeto</FormLabel>
                ...
                <Stack direction={{ base: "row", sm: "column", md: "row" }} alignItems="end">
                  <Box w="75%" h="100%">
                    <CardForm>
                      <FormControl>
                        <FormLabel bgGradient="linear(to-b, #B7F9A8, #32821C)" bgClip="text">Descrição</FormLabel>
                        <Textarea
                          id="instructions"
                          name="instructions"
                          rows={10}
                  ...
                  <CardForm>
                    <FormControl>
                      <FormLabel bgGradient="linear(to-b, #B7F9A8, #32821C)" bgClip="text">Imagem do Projeto</FormLabel>
